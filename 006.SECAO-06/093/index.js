 ...
 * primeira vez, servindo de modelo oiu molde para futuras produções.
 * 
 * Todos os objetos tem uma referência intena para um protótipo (__proto__)
 * que vem da propriedade  prototype da função construtora que foi usada para criá-lo.
 * Quando tentamos acessar um membro de um objeto, primeiro o motor
...
const pessoa1 = new Pessoa('Fábio', 'O.'); // <- Pessoa = Função Construtora
